namespace CMBT
{
  ...
  /// <summary>
  /// Defines the <see cref="BTAudioMeasurement_Left" />
  /// </summary>
  public partial class BTAudioMeasurement_Left : Form
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="BTAudioMeasurement_Left"/> class.
    /// </summary>
    /// <param name="parent">The <see cref="BTAuto"/></param>
    public BTAudioMeasurement_Left(BTAuto parent)
    {
      InitializeComponent();
    }
